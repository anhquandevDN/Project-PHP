...
else
{
 ...
 // Truy vấn dữ liệu sản phẩm từ cơ sở dữ liệu với phân trang
 $sql = "SELECT * FROM product LIMIT $start, $productsPerPage";
...
<table class="table">
  ...
  <?php 
  for ($i = 1;$i <= ceil(mysqli_num_rows($result1) / $productsPerPage); $i++): ?>
